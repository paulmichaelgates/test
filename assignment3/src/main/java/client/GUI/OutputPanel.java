...
public class OutputPanel extends JPanel {
    ...
    ) 
  {
    ...
    //                     JTextField textField = (JTextField) e.getSource();
    //                     messageActionListener.messagePacket.msg_data = textField.getText();
    ...
    submit.addActionListener(new ActionListener() {
      ...
      {
        /**
         * set the message packet data to the input text field
         */
        messageActionListener.messagePacket.msg_data = input.getText();
